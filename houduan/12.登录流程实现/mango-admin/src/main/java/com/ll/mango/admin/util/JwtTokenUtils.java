...
import com.ll.mango.admin.security.GrantedAuthorityImpl;
...
public class JwtTokenUtils implements Serializable {
    ...
    /**
     * 尝试从请求头中获取请求携带的令牌，默认从请求头中的“Authorization”参数以“Bearer”开头的信息为令牌信息，
     * 如果为空的情况下，尝试从“token"参数获取
     * @param request
     * @return
     */
